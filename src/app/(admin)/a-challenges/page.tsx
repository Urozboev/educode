...
export default function AdminChallengesPage() {
  ...
  function openEdit(c: Challenge) {
    setForm({
      ...
      starter_python: c.starter_code?.python || "",
      starter_js: c.starter_code?.javascript || "",
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                value={form.starter_python}
                onChange={(e) =>
                  setForm({ ...form, starter_python: e.target.value })
                }
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setForm({ ...form, starter_js: e.target.value })
                }
                className="input-field font-mono text-sm min-h-[80px]"
              />
            </div>
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setForm({ ...form, test_cases: e.target.value })
                }
                className="input-field font-mono text-xs min-h-[100px]"
              />
              <p className="text-[10px] text-muted-foreground mt-1">{`[{"input":"5 3","expected_output":"8","is_hidden":false}]`}</p>
            </div>
            <div className="md:col-span-2">
              <label className="text-sm font-medium mb-1 block">
                Yashirin test case'lar (JSON)
              </label>
              <textarea
                value={form.hidden_test_cases}
                onChange={(e) =>
                  setForm({ ...form, hidden_test_cases: e.target.value })
                }
